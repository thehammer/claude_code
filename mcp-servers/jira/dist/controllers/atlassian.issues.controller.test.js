...
describe('Atlassian Issues Controller', () => {
    ...
    describe('list', () => {
        it('should format issues list correctly', async () => {
            ...
            const hasNewFormat = result.content.includes('items.') &&
        ...
        it('should handle error for invalid JQL', async () => {
            ...
            try {
                ...
                await atlassian_issues_controller_js_1.default.list({
    ...
    describe('get', () => {
        ...
        it('should include optional fields when requested', async () => {
            ...
            const issueKey = await getFirstIssueKey();
            if (!issueKey) {
                console.warn('Skipping optional fields test: No issue key found');
                return;
            }
            // Call the controller with the issue key
            const result = await atlassian_issues_controller_js_1.default.get({
        ...
        it('should handle non-existent issue gracefully', async () => {
            ...
            try {
                await atlassian_issues_controller_js_1.default.get({
