...
const atlassian_comments_controller_js_1 = __importDefault(require("./atlassian.comments.controller.js"));
    ...
    describe('listComments', () => {
        ...
        it('should handle error for invalid issue key', async () => {
            if (skipIfNoCredentials())
                return;
            try {
                await atlassian_comments_controller_js_1.default.listComments({
