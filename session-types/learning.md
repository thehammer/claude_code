...
| **connie** | Read documentation, design docs | "Use connie to get the API design document" |
...
2. **Documentation Mode** → Use **connie** for internal docs, WebFetch for external
